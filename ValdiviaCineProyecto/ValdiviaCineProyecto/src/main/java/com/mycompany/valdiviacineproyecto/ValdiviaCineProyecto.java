...
package com.mycompany.valdiviacineproyecto;

import ControladorVista.Controladora;
import Iniciador.DataInitializer;
 ...
 * @author Usuario
 */
public class ValdiviaCineProyecto {

    public static void main(String[] args) {
        // Crear el EntityManagerFactory y EntityManager
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("CineJPAPU");
        EntityManager em = emf.createEntityManager();

        try {
            // Crear el inicializador de datos
            DataInitializer initializer = new DataInitializer(em);
            
            // Llamar al método para insertar los datos
            initializer.insertarDatos();
        ...
        Controladora controlVista = new Controladora(control, inicioView);
    }
}
...
//            pelicula1.setTitulo("Hereje");
//            pelicula1.setGenero(Genero.DRAMA);
//            pelicula1.setCinep(cine2); // Relacionamos el cine
...
//            funcion1.setHorario("23:00");
//            funcion1.setPelicula(pelicula2);
//            funcion1.setSala(salaVip1);
//            em.persist(funcion2);
//            
